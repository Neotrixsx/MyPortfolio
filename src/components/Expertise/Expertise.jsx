...
const Expertise = () => {
  return (
    <section className="expertiseWrapper">
      ...
      <motion.div
        ...
        className="paddings yPaddings innerWidth flexCenter expertiseContainer"
      >
        {/* left side */}
        ...
        {/* right */}
        <motion.div variants={textVariant(0.5)} className="rightSide">
